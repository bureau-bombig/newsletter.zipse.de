...
class com_maileon_api_contacts_ContactsService extends com_maileon_api_AbstractMaileonService
{
     ...
     * @param array $nlAccounts Optional parameter to define in which accounts the email should be unsubscribed. Note: The accounts must belong to the owner of the API key in use, otherwise they will be ignored.
     * @return \em com_maileon_api_MaileonAPIResult
     *    the result object of the API call
     * @throws com_maileon_api_MaileonAPIException
     *  if there was a connection problem or a server error occurred
     */
    function unsubscribeContactByEmail($email, $mailingId = "", $reasons = null, $nlAccountIds = array())
    {
        $queryParameters = array();
        if (!empty($mailingId)) {
