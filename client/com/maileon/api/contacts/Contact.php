 ...
 */
class com_maileon_api_contacts_Contact extends com_maileon_api_xml_AbstractXMLWrapper
{
    public $id;
    public $email;
    public $permission;
    ...
    function fromXML($xmlElement)
    {
        ...
        if (isset($xmlElement->permission)) $this->permission = com_maileon_api_contacts_Permission::getPermission((string)$xmlElement->permission);
    ...
    function toXML($addXMLDeclaration = true)
    {
        ...
        if (isset($this->standard_fields)) {
            ...
            foreach ($this->standard_fields as $index => $value) {
                ...
                com_maileon_api_xml_XMLUtils::addChildAsCDATA($field, "value", $value);
